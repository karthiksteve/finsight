...
async def get_rag_status():
    ...
    stats = {
        ...
        "llm_model": Config.LMSTUDIO_MODEL if Config.LLM_PROVIDER == "lmstudio" else None,
        "lmstudio_url": Config.LMSTUDIO_BASE_URL if Config.LLM_PROVIDER == "lmstudio" else None,
    }
