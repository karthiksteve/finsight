  ...
  const features = [
    {
      ...
      description:
        "Advanced Named Entity Recognition for financial documents using BERT/FinBERT models",
    ...
    },
    {
      ...
      description:
        "Extract entities from SEC filings, earnings reports, and financial news",
    ...
    },
    {
      ...
      description:
        "Identify companies, stock prices, revenue, market cap, and financial events",
    ...
    },
    {
      ...
      description:
        "Transform extracted data into actionable insights and visualizations",
  ...
  const processSteps = [
    {
      ...
      description:
        "Upload SEC filings, earnings reports, or financial articles",
      icon: Cloud,
    },
    {
      step: "2",
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto py-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Extract meaningful financial insights from documents using
              advanced
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              From financial documents to actionable insights in four simple
              steps
            </p>
          </motion.div>
      ...
      <section className="py-20 px-6 bg-gray-50/50 dark:bg-horizon-secondary/20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Powered by state-of-the-art AI models trained specifically for
              financial data
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
              Start using advanced NER technology to transform your financial
